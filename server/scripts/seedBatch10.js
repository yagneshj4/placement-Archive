...
import batch10 from './batch10Data.js';
...
async function seedBatch10() {
  try {
      ...
      await User.insertMany([
        {
          ...
          email: 'batch10.student1@vrsec.ac.in',
        ...
        },
        {
          ...
          email: 'batch10.student2@vrsec.ac.in',
          passwordHash: 'Student@1234',
          role: 'student',
          college: 'VR Siddhartha Engineering College',
          graduationYear: 2025,
    ...
    const experiencesWithUser = batch10.map((exp) => ({
      ...exp,
    ...
    console.log('Batch 10 processed successfully.');
    ...
    console.error('Error seeding Batch 10:', error.message);
    process.exit(1);
  }
}
