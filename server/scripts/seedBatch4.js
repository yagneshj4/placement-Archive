...
import batch4 from './batch4Data.js';
...
async function seedBatch4() {
  try {
      ...
      await User.insertMany([
        {
          ...
          email: 'batch4.student1@vrsec.ac.in',
        ...
        },
        {
          ...
          email: 'batch4.student2@vrsec.ac.in',
          passwordHash: 'Student@1234',
          role: 'student',
          college: 'VR Siddhartha Engineering College',
          graduationYear: 2025,
    ...
    const readyBatch = batch4.map((exp) => ({
      ...exp,
    ...
    console.log('Batch 4 processed successfully.');
