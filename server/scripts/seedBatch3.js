...
import batch3 from './batch3Data.js';
...
async function seedBatch3() {
  try {
      ...
      await User.insertMany([
        {
          ...
          email: 'batch3.student1@vrsec.ac.in',
        ...
        },
        {
          ...
          email: 'batch3.student2@vrsec.ac.in',
          passwordHash: 'Student@1234',
          role: 'student',
          college: 'VR Siddhartha Engineering College',
          graduationYear: 2025,
    ...
    const readyBatch = batch3.map((exp) => ({
      ...exp,
    ...
    console.log('Batch 3 processed successfully.');
