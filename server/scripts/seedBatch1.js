...
import batch1 from './batch1Data.js';
...
async function seedBatch1() {
  try {
      ...
      await User.insertMany([
        {
          ...
          email: 'batch1.student1@vrsec.ac.in',
        ...
        },
        {
          ...
          email: 'batch1.student2@vrsec.ac.in',
          passwordHash: 'Student@1234',
          role: 'student',
          college: 'VR Siddhartha Engineering College',
          graduationYear: 2025,
        ...
        {
          name: 'Batch Seeder Admin',
          email: 'batch1.admin@vrsec.ac.in',
    ...
    const readyBatch = batch1.map((exp) => ({
      ...exp,
    ...
    console.log('Batch 1 processed successfully.');
