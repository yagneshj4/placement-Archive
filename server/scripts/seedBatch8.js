...
import batch8 from './batch8Data.js';
...
async function seedBatch8() {
  try {
      ...
      await User.insertMany([
        {
          ...
          email: 'batch8.student1@vrsec.ac.in',
        ...
        },
        {
          ...
          email: 'batch8.student2@vrsec.ac.in',
          passwordHash: 'Student@1234',
          role: 'student',
          college: 'VR Siddhartha Engineering College',
          graduationYear: 2025,
    ...
    const experiencesWithUser = batch8.map((exp) => ({
      ...exp,
    ...
    console.log('Batch 8 processed successfully.');
    ...
    console.error('Error seeding Batch 8:', error.message);
    process.exit(1);
  }
}
