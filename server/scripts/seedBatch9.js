...
import batch9 from './batch9Data.js';
...
async function seedBatch9() {
  try {
      ...
      await User.insertMany([
        {
          ...
          email: 'batch9.student1@vrsec.ac.in',
        ...
        },
        {
          ...
          email: 'batch9.student2@vrsec.ac.in',
          passwordHash: 'Student@1234',
          role: 'student',
          college: 'VR Siddhartha Engineering College',
          graduationYear: 2025,
    ...
    const experiencesWithUser = batch9.map((exp) => ({
      ...exp,
    ...
    console.log('Batch 9 processed successfully.');
    ...
    console.error('Error seeding Batch 9:', error.message);
    process.exit(1);
  }
}
