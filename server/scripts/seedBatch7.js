...
import batch7 from './batch7Data.js';
...
async function seedBatch7() {
  try {
      ...
      await User.insertMany([
        {
          ...
          email: 'batch7.student1@vrsec.ac.in',
        ...
        },
        {
          ...
          email: 'batch7.student2@vrsec.ac.in',
          passwordHash: 'Student@1234',
          role: 'student',
          college: 'VR Siddhartha Engineering College',
          graduationYear: 2025,
    ...
    const experiencesWithUser = batch7.map((exp) => ({
      ...exp,
    ...
    console.log('Batch 7 processed successfully.');
    ...
    console.error('Error seeding Batch 7:', error.message);
    process.exit(1);
  }
}
